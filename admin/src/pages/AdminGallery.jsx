...
const AdminGallery = () => {
  ...
  useEffect(() => {
    const fetchAlbums = async () => {
      try {
        const response = await axios.get('https://ss-infotech-v2-2.onrender.com/api/albums/album-getall');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEditing) {
        const response = await axios.patch(`https://ss-infotech-v2-2.onrender.com/api/albums/album/${editId}`, data, {
        ...
        const response = await axios.post('https://ss-infotech-v2-2.onrender.com/api/albums/album-post', data, {
          headers: { 'Content-Type': 'multipart/form-data' },
        });
  ...
  const handleDelete = async (_id) => {
    ...
    try {
      await axios.delete(`https://ss-infotech-v2-2.onrender.com/api/albums/album/${_id}`);
